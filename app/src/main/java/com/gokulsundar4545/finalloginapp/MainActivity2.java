...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLoadindBar = new ProgressDialog(MainActivity2.this);
    ...
    private void checkCredentials() {
        ...
        if (Username.isEmpty() || Username.length() < 7) {
            ...
            showError(inputPassWord1, "passWord in must be 7Characters");
        } else if (ConformPassWord.isEmpty() || !ConformPassWord.equals(Password)) {
            showError(inputConformPassWord1, "passWord not match!");
        } else if (PhoneNo2.isEmpty() || PhoneNo2.length() < 10 || PhoneNo2.length() > 10) {
            showError(PhoneNo1, "Phone Number is inValed");
        } else {
